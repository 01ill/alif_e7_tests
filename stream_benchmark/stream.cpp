...
static constexpr uint32_t ARRAY_SIZE = 10000;
static constexpr uint32_t ITERATIONS = 100;
static constexpr uint32_t RESULTS = 13;
...
static uint32_t mintime[RESULTS] = {UINT32_MAX,UINT32_MAX,UINT32_MAX,UINT32_MAX, UINT32_MAX, UINT32_MAX, UINT32_MAX, UINT32_MAX, UINT32_MAX, UINT32_MAX, UINT32_MAX, UINT32_MAX, UINT32_MAX};
